(function(root, factory) {
  ...
  var pxDemo = (function() {
    ...
    var BACKGROUNDS = [
      'public/assets/demo/bgs/1.jpg',
      'public/assets/demo/bgs/2.jpg',
      'public/assets/demo/bgs/3.jpg',
      'public/assets/demo/bgs/4.jpg',
      'public/assets/demo/bgs/5.jpg',
      'public/assets/demo/bgs/6.jpg',
      'public/assets/demo/bgs/7.jpg',
      'public/assets/demo/bgs/8.jpg',
      'public/assets/demo/bgs/9.jpg',
    ];
    ...
    function setTheme(themeName) {
      ...
      var themePath = 'public/assets/css/themes/' + themeName + (_isRtl ? '.rtl' : '') + '.min.css';
    ...
    function initializeDemoSidebar(container, skipFooter) {
      ...
      for (var i = 0, l = THEMES.length; i < l; i++) {
        content += '<label class="px-demo-themes-item">';
          ...
          content += '<img src="public/assets/demo/themes/' + THEMES[i] + '.png" class="px-demo-themes-thumbnail">';
